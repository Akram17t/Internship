...
Setiap jawaban asisten menampilkan baris \textbf{Is this helpful?} dengan dua ikon jempol tepat di bawah info \textit{AI Assistant}, waktu, dan sumber jawaban.
...
Klik \textbf{Finalize} setelah perubahan pada SOP/knowledge document agar chatbot memakai sumber terbaru.
...
Menu \textbf{Guardrails} dipakai untuk mengatur batasan yang disuntikkan ke setiap jawaban AI: topik apa saja yang boleh dijawab, dan bagaimana chatbot harus bersikap saat pertanyaan di luar topik SOP atau saat ada percobaan mengubah/membocorkan instruksi sistemnya.
